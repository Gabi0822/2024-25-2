			...
			<div class="container-fluid mx-5">
				...
				<div class="collapse navbar-collapse" id="main-navbar">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item">
							<a class="nav-link" href="lezart_feladatok.html"
								>Lezárt feladatok</a
							>
						</li>
						<li class="nav-item">
						...
						<li class="nav-item">
							<a class="nav-link" href="felhasznalok.html"
								>Felhasználók (ADMIN)</a
							>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="feladatok.html"
								>Összes feladat (ADMIN)</a
							>
						</li>
					</ul>
					<div class="d-flex">
